...
public class OpenHandler {
	...
	@Execute
	public void execute(IEclipseContext context, @Named(IServiceConstants.ACTIVE_SHELL) Shell shell) throws InvocationTargetException,
		...
		try {
			...
			if (dao == null) {
				System.err.println("Dao was not injected");
			} else {
